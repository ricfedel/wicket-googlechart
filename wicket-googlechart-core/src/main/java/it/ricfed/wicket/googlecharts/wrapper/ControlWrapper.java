...
public abstract class ControlWrapper<S extends State, O extends ControlOptions>
		extends Wrapper implements Serializable {
	...
	protected Class<S> getClassState() {
		if (classState == null) {
			classState = (Class<S>) ClassHelper.findGenericClass(getClass(), 0);
		}
		return classState;
	}
